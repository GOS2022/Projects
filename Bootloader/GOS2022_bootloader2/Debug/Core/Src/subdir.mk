...
clean-Core-2f-Src:
	-$(RM) ./Core/Src/app.cyclo ./Core/Src/app.d ./Core/Src/app.o ./Core/Src/app.su ./Core/Src/app_bld.cyclo ./Core/Src/app_bld.d ./Core/Src/app_bld.o ./Core/Src/app_bld.su ./Core/Src/app_iplBdSpec.cyclo ./Core/Src/app_iplBdSpec.d ./Core/Src/app_iplBdSpec.o ./Core/Src/app_iplBdSpec.su ./Core/Src/app_led.cyclo ./Core/Src/app_led.d ./Core/Src/app_led.o ./Core/Src/app_led.su ./Core/Src/app_pdhBdSpec.cyclo ./Core/Src/app_pdhBdSpec.d ./Core/Src/app_pdhBdSpec.o ./Core/Src/app_pdhBdSpec.su ./Core/Src/app_sdhBdSpec.cyclo ./Core/Src/app_sdhBdSpec.d ./Core/Src/app_sdhBdSpec.o ./Core/Src/app_sdhBdSpec.su ./Core/Src/syscalls.cyclo ./Core/Src/syscalls.d ./Core/Src/syscalls.o ./Core/Src/syscalls.su ./Core/Src/sysmem.cyclo ./Core/Src/sysmem.d ./Core/Src/sysmem.o ./Core/Src/sysmem.su ./Core/Src/system_stm32f4xx.cyclo ./Core/Src/system_stm32f4xx.d ./Core/Src/system_stm32f4xx.o ./Core/Src/system_stm32f4xx.su
