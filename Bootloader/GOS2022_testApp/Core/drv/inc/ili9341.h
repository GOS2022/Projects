...
void ili9341_set_touch_pressed_begin(
    ili9341_touch_callback_t callback);
void ili9341_set_touch_pressed_end(
    ili9341_touch_callback_t callback);
...
void ili9341_spi_slave_select(
    ili9341_spi_slave_t spi_slave);
void ili9341_spi_slave_release(
    ili9341_spi_slave_t spi_slave);

void ili9341_spi_write_command(
    ili9341_spi_slave_t spi_slave, uint8_t command);
void ili9341_spi_write_data(
