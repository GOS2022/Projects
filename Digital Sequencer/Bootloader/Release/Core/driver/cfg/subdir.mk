...
clean-Core-2f-driver-2f-cfg:
	-$(RM) ./Core/driver/cfg/dma_cfg.cyclo ./Core/driver/cfg/dma_cfg.d ./Core/driver/cfg/dma_cfg.o ./Core/driver/cfg/dma_cfg.su ./Core/driver/cfg/dsm_cfg.cyclo ./Core/driver/cfg/dsm_cfg.d ./Core/driver/cfg/dsm_cfg.o ./Core/driver/cfg/dsm_cfg.su ./Core/driver/cfg/gpio_cfg.cyclo ./Core/driver/cfg/gpio_cfg.d ./Core/driver/cfg/gpio_cfg.o ./Core/driver/cfg/gpio_cfg.su ./Core/driver/cfg/i2c_cfg.cyclo ./Core/driver/cfg/i2c_cfg.d ./Core/driver/cfg/i2c_cfg.o ./Core/driver/cfg/i2c_cfg.su ./Core/driver/cfg/it_cfg.cyclo ./Core/driver/cfg/it_cfg.d ./Core/driver/cfg/it_cfg.o ./Core/driver/cfg/it_cfg.su ./Core/driver/cfg/spi_cfg.cyclo ./Core/driver/cfg/spi_cfg.d ./Core/driver/cfg/spi_cfg.o ./Core/driver/cfg/spi_cfg.su ./Core/driver/cfg/sysmon_cfg.cyclo ./Core/driver/cfg/sysmon_cfg.d ./Core/driver/cfg/sysmon_cfg.o ./Core/driver/cfg/sysmon_cfg.su ./Core/driver/cfg/tmr_cfg.cyclo ./Core/driver/cfg/tmr_cfg.d ./Core/driver/cfg/tmr_cfg.o ./Core/driver/cfg/tmr_cfg.su ./Core/driver/cfg/uart_cfg.cyclo ./Core/driver/cfg/uart_cfg.d ./Core/driver/cfg/uart_cfg.o ./Core/driver/cfg/uart_cfg.su
